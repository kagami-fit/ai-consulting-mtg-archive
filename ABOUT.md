...
- `public/records/2026-08-08-hp-sales-sns-kpi-mtg/diagram.png` — 第9回HP制作・営業/SNS自動化MTGの図解画像
- `public/records/2026-08-13-site-wordpress-sns-mtg/diagram.png` — 第10回サイト改修・WordPress化MTGの図解画像
- `public/records/2026-08-15-sns-skill-automation-mtg/diagram.png` — 第11回SNS投稿自動化MTGの図解画像
- `public/records/2026-08-23-web-sns-knowledge-operations-mtg/diagram.png` — 第12回Webサイト・SNS・ナレッジ運用MTGの図解画像
- `public/records/2026-08-29-site-operations-ui-mtg/diagram.png` — 第13回サイト運用・UI/UX改善MTGの図解画像
...
- `public/transcripts/2026-08-08-hp-sales-sns-kpi-mtg.html` — 第9回HP制作・営業/SNS自動化MTGのPlaud統合要約メモビューア
- `public/transcripts/2026-08-08-hp-sales-sns-kpi-mtg.txt` — 第9回HP制作・営業/SNS自動化MTGのPlaud統合要約メモ
- `public/transcripts/2026-08-13-site-wordpress-sns-mtg.html` — 第10回サイト改修・WordPress化MTGのPlaud要約メモビューア
- `public/transcripts/2026-08-13-site-wordpress-sns-mtg.txt` — 第10回サイト改修・WordPress化MTGのPlaud要約メモ
- `public/transcripts/2026-08-15-sns-skill-automation-mtg.html` — 第11回SNS投稿自動化MTGのPlaud統合要約メモビューア
- `public/transcripts/2026-08-15-sns-skill-automation-mtg.txt` — 第11回SNS投稿自動化MTGのPlaud統合要約メモ
- `public/transcripts/2026-08-23-web-sns-knowledge-operations-mtg.html` — 第12回Webサイト・SNS・ナレッジ運用MTGのPlaud要約メモビューア
- `public/transcripts/2026-08-23-web-sns-knowledge-operations-mtg.txt` — 第12回Webサイト・SNS・ナレッジ運用MTGのPlaud要約メモ
- `public/transcripts/2026-08-29-site-operations-ui-mtg.html` — 第13回サイト運用・UI/UX改善MTGのPlaud要約メモビューア
- `public/transcripts/2026-08-29-site-operations-ui-mtg.txt` — 第13回サイト運用・UI/UX改善MTGのPlaud要約メモ
...
- `public/records/` — 稼働中。初回相談、第1回〜第13回MTGの図解画像を配置済み
- `public/reports/` — 稼働中。名刺OCR・Google Drive連携案を配置済み
- `public/templates/` — 稼働中。名刺管理シートCSVテンプレートを配置済み
- `public/transcripts/` — 稼働中。初回相談、第1回〜第3回MTGの文字起こし全文、第4回〜第13回MTGのPlaud要約メモを配置済み
